...
export class Tab3Page implements OnInit {
  ...
  constructor(private readonly toastController: ToastController, private readonly zone: NgZone, private readonly loading: LoadingController) { }
  ...
  async ionViewDidEnter() {
    ...
    this.requestPermissions().finally(() => {
      loading.dismiss();
    });
  }
